...
<body>
    ...
    <main class="contenedor panel sombra">
        <h1>Términos y Condiciones de Uso de Sitio Web</h1>
        <ol>
            <li>ACEPTACIÓN</li>
            <p>En el presente documento (en adelante, el “Contrato”) se establecen los términos y condiciones de Robert Half Internacional Empresa de Servicios Transitorios Limitada, con domicilio en Avenida Isidora Goyenechea 2800 Piso 15. Torre Titanium 7550-647 Las Condes, que serán de aplicación al acceso y uso por parte del Usuario de esta página web (el  “Sitio Web”). Les rogamos lean atentamente el presente Contrato. 
            ...
            El Usuario asume y acepta que RH podrá conservar copia de la Información del Usuario, y revelar dicha información a terceros si lo considera necesario para:
                <ol>
                    ...
                    <li>hacer valer los derechos y acciones que asisten a RH a tenor de este Contrato; y</li>
                    <li>satisfacer cualquier petición relativa a la infracción de derechos de terceros.</li>
                </ol>
            </p>
            ...
            <ol>
                <li>incumplir todas las leyes, reglamentos y normas aplicables a nivel local, estatal, provincial, nacional (Chile), así como cualquier otra legislación aplicable como las leyes contra la discriminación laboral o las leyes por la igualdad de oportunidades en el empleo, cuando proceda;</li>
                <li>infringir los derechos de propiedad intelectual y de privacidad, entre otros, los derechos de patente (copyright), los derechos sobre la base de datos, las marcas registradas o el know how de terceros;</li>
                <li>descargar, enviar, transmitir o almacenar material que:</li>
                    <ul>
                        <li>sea ilegal, ofensivo, difamatorio, fraudulento, engañoso, que induzca a error, dañino, amenazador, hostil, obsceno o censurable;</li>
                        <li>infrinja las obligaciones contractuales o de confidencialidad del Usuario;</li>
                        <li>perjudique o interfiera en las aplicaciones normales del Sitio Web, como el envío o la transmisión de virus, gusanos o troyanos, el envío continuado de material repetido o el envío de archivos desacostumbradamente grandes;</li>
                        <li>o que no esté permitido por RH, como, por ejemplo, material publicitario no autorizado, material promocional no solicitado, “correo basura”, “spams”, “cartas en cadena”, mensajes de venta directa piramidal, franquicias, material de distribución, de asociación a un club, contratos de venta o cualquier otro material inaceptable;</li>
                    </ul>
                <li>vulnerar los derechos personales y de privacidad de terceros abusando del Contenido, como, por ejemplo, acosando o molestando continuadamente a dichas personas enviándoles correos electrónicos no solicitados, o recabando información de carácter personal;</li>
                <li>contravenir, o intentar contravenir, las medidas de seguridad del Sitio Web;</li>
                <li>utilizar cualquier aparato, procedimiento o mecanismo como, por ejemplo, spiders y robots de rastreo, para localizar, rescatar, buscar, o acceder al Sitio Web o al Contenido, sin el previo consentimiento por escrito de parte de RH;</li>
                <li>acceder o intentar acceder a la cuenta o al login de las terceras personas o empresas indicadas en el Sitio Web;</li>
                <li>copiar, modificar, reproducir, eliminar, distribuir, descargar, almacenar, transmitir, vender, revender, publicar, invertir el proceso de creación o crear productos derivados a partir del Contenido, excepto en lo que concierne al material remitido por el propio Usuario y que es de su propiedad, o si así lo autorizan las leyes de propiedad intelectual aplicables;</li>
                <li>enviar o facilitar información incorrecta, falsa o incompleta, en relación con el currículum vitae, los datos biográficos, la fecha en que empezó a trabajar o el perfil de la empresa del Usuario;</li>
                <li>hacerse pasar por otra persona o empresa;</li>
                <li>utilizar el Sitio Web de forma no autorizada o para alguna actividad delictiva;</li>
                <li>falsificar la información de cabecera en el correo electrónico; o</li>
                <li>falsear los datos sobre sí mismo, sobre su asociación con terceros o sobre su empresa.</li>
            </ol>
            </p>
            ...
            <ol>
                <li>utilizar el Sitio Web únicamente para los fines legalmente permitidos de buscar empleo y recabar información profesional;</li>
                <li>facilitar y mantener los datos personales que conforman la Información del Usuario de forma completa, correcta, actualizada y veraz;</li>
                <li>enviar solamente material sobre el que el Usuario tenga los correspondientes derechos o licencia para hacerlo;</li>
                <li>utilizar su propio criterio, precaución y sentido común al gestionar las oportunidades de empleo y la información  conseguida a través del Sitio Web; y</li>
                <li>asumir el riesgo de confiar en el contenido, o utilizar la información, facilitados por terceros.</li>
            </ol>
            </p>
            ...
            <ol>
                <li>mantener la confidencialidad de dichos números de cuenta virtual y contraseña;</li>
                <li>actualizar y comprobar frecuentemente su contraseña; y</li>
                <li>notificar inmediatamente a RH, si tiene conocimiento del uso no autorizado de su cuenta o de cualquier vulneración de las medidas de seguridad.</li>
            </ol></p>
            
            <li>EMPLEO</li>
            <p>El Usuario asume y acepta que RH:
            <ol>
                <li>no garantiza que el Usuario reciba efectivamente una oferta de empleo a través del Sitio Web;</li>
                <li>no se responsabiliza de las ofertas de empleo, la comprobación de dichas ofertas, las decisiones sobre contratación que adopten y los trabajos que oferten terceras personas o empresas;</li>
                <li>no garantiza la exactitud, integridad, validez o vigencia de la información incluida en la Web por terceras personas o empresas;</li>
                <li>aunque RH revisa el material de terceros y solamente permite la inclusión del material que, a su leal saber y entender, no infringe la legislación aplicable, no asumirá responsabilidad alguna por el material enviado por terceros, como, por ejemplo, la información relativa a la creación de puestos de trabajo en una empresa o la incluida en las listas de empleo; y</li>
                <li>no es ni una empresa que contrata al Usuario ni existe contrato de agencia alguno. El Usuario deberá usar su buen juicio, precaución y sentido común a la hora de evaluar las empresas que puedan contratarle y la información facilitada por terceros.</li>
            </ol></p>

            <li>VÍNCULOS A PÁGINAS WEB DE TERCEROS</li>
            <p>El Sitio Web puede tener vínculos, como hipervínculos o enlaces, que indican el acceso a páginas Web de terceros (los “Sitios Relacionados”). Aunque RH revisa el material de terceros y solamente permite la inclusión de los Sitios Relacionados que, a su leal saber y entender, no infringen la legislación aplicable, RH no puede controlar ni realizar un seguimiento de los Sitios Relacionados y, en consecuencia, no asumirá responsabilidad alguna en cuanto a la exactitud, seguridad o fiabilidad del material, información o contenido incluido en dichos Sitios Relacionados. 
            ...
            <li>PRIVACIDAD</li>
            <p>RH procesará toda la información personal que el Usuario introduzca o facilite a través de nuestro Sitio Web de conformidad con la Política de
            > Privacidad del Sitio Web y los términos y condiciones relativos a la misma en este contrato.</p>
            ...
            EN CUALQUIER CASO, LA ANTERIOR LIMITACIÓN DE RESPONSABILIDAD NO SE APLICARÁ A LOS CONSUMIDORES NI RESPECTO A LOS DAÑOS CAUSADOS DE FORMA INTENCIONADA O NEGLIGENCIA GRAVE.</p>

            <li>RESCISIÓN</li>
            <p>RH podrá, a su entera discreción, dar por terminados los servicios ofrecidos en su Sitio Web y retirar cualquier Contenido del mismo. RH podrá también, en cualquier momento, por cualquier motivo justificado o no y sin tener que notificar de forma anticipada su decisión, suspender el acceso del Usuario a cualquiera de, o a todos, los servicios ofrecidos en el Sitio Web. En caso de que el Usuario decida anular su cuenta, deberá dejar de acceder a, y no utilizar más, el Sitio Web. RH no tendrá obligación alguna de mantener o devolver la Información facilitada por el Usuario, su cuenta, su número de cuenta virtual y su contraseña. El Usuario deberá disponer siempre de una copia de la Información por él facilitada.</p>

            <li>GENERAL</li>
            <p>El Usuario declara que entre él y RH no existe relación alguna de contratación laboral, asociación, agencia o empresa conjunta, derivadas del acceso y uso del Sitio Web.
